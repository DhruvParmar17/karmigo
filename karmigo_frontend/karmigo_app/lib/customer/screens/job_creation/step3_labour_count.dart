...
import 'step4_details.dart';

class Step3LabourCountScreen extends StatefulWidget {
  final JobCreationState state;

  const Step3LabourCountScreen({super.key, required this.state});

  @override
  _Step3LabourCountScreenState createState() => _Step3LabourCountScreenState();
}

class _Step3LabourCountScreenState extends State<Step3LabourCountScreen> {
  int _count = 1;
  ...
  void _next() {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) => Step4DetailsScreen(state: widget.state),
      ),
    );
  }
